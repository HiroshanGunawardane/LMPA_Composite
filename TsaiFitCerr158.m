...
% --- Optimize Tsai Model for Cerr 158 ---
cerr158Data = sortrows(allData(allData.Material == 'Cerr 158', :), 'ConcentrationNumeric');
cerr_exp = cerr158Data.YoungModulus_MPa * 1e6;
Vf_cerr = cerr158Data.ConcentrationNumeric / 100;
...
fprintf('\nOptimized Tsai model parameters (for Cerr 158):\n');
fprintf('  a = %.4f\n', optimal_a);
fprintf('  b = %.4f\n', optimal_b);
